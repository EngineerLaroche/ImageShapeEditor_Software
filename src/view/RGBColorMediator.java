...
import colorPicker.ColorDialogResult;
 ...
 */
public class RGBColorMediator extends Object implements SliderObserver, ObserverIF {
	ColorSlider redCS;
	ColorSlider greenCS;
	ColorSlider blueCS;
	int red;
	...
	public RGBColorMediator(ColorDialogResult result, int imagesWidth, int imagesHeight) {
